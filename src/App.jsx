...
const MAP_PLATFORM_DATA = {
  ...
  103000102: { healCoverage:5, platforms:3, layout:"flat",    estimated:true, notes:"3 long flat platforms stacked closely. Monsters cluster in lanes. Excellent Heal map." },
  105060000: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"2 wide flat platforms. Good density, minimal movement needed." },
  105050400: { healCoverage:3, platforms:4, layout:"tiered",  estimated:true, notes:"4 platforms with moderate vertical spread. Heal hits 2-3 per platform." },
  103000103: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"2 long platforms. Monsters spread along length but Heal range covers well." },
  103000104: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Similar to Line 1 Area 2. Good flat layout." },
  103000200: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"3 platforms with some vertical gap. Moderate Heal efficiency." },

  // -- Sleepywood / Ant Tunnels (Zombie Mushroom / Jr. Boogie) --
  105090200: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"2 wide platforms. Zombie Mushrooms cluster well. Good Heal map." },
  105090300: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"3 platforms, slightly more vertical. Jr. Boogie here too - high MDEF hurts Heal." },
  105090400: { healCoverage:2, platforms:4, layout:"tiered",  estimated:true, notes:"4 platforms with significant vertical spread. Heal coverage drops quickly." },
  105070000: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Classic flat ant tunnel. Long single platform each level. Very good Heal map." },
  105070100: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Same as Ant Tunnel I. Consistent flat layout." },
  105070200: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Ant Tunnel III. Zombie Mushrooms spawn here. Flat = good Heal coverage." },
  105070300: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Ant Tunnel IV. More vertical than III. Jr. Boogie with 50 MDEF - Heal less effective." },
  105040000: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Swampy Land. Water on the floor drains MP. Stay on platforms - limited casting area." },
  105040300: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Swampy Area. MP water present. Must stay elevated to cast." },

  // -- Kerning City (Jr. Wraith / Wraith) --
  103000000: { healCoverage:4, platforms:3, layout:"flat",    estimated:true, notes:"Kerning Sewer. 3 well-spaced flat platforms. Classic Wraith map. Good Heal coverage." },
  103010000: { healCoverage:3, platforms:4, layout:"tiered",  estimated:true, notes:"Kerning Alley. More platforms with gaps. Moderate movement." },
  103020000: { healCoverage:2, platforms:5, layout:"vertical", estimated:true, notes:"Abandoned Mine. Tall vertical map with rope-linked platforms. Poor Heal map - too spread out." },
  103000900: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Forgotten Tunnel. 2 long flat platforms. Good Heal coverage." },
  102040000: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Construction Site. 3 platforms but irregular spacing." },

  // -- Ludibrium (Chronos / Zombie Lupin / Soul Teddy / Death Teddy) --
  221020100: { healCoverage:5, platforms:1, layout:"flat",    estimated:true, notes:"Eos Tower 1F-20F. Single wide platform per floor. Monsters stack flat. Best Heal map in Ludi." },
  221020200: { healCoverage:5, platforms:1, layout:"flat",    estimated:true, notes:"Eos Tower 21F-40F. Same layout. Excellent Heal coverage." },
  221020300: { healCoverage:5, platforms:1, layout:"flat",    estimated:true, notes:"Eos Tower 41F-60F. Single platform. Chronos stacks well for Heal." },
  221020400: { healCoverage:5, platforms:1, layout:"flat",    estimated:true, notes:"Eos Tower 61F-75F. Single platform. Best Chronos map." },
  222000000: { healCoverage:4, platforms:2, layout:"flat",    estimated:true, notes:"Helios Tower 1F-20F. 2 flat platforms. Good Heal coverage." },
  220060000: { healCoverage:2, platforms:5, layout:"vertical", estimated:true, notes:"Sky Terrace I. Open multi-level with large gaps. Poor Heal map - lots of jumping." },
  220060100: { healCoverage:2, platforms:5, layout:"vertical", estimated:true, notes:"Sky Terrace II. Same open vertical layout. Not ideal for Heal." },
  221020000: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Eos Tower 76F-90F. Multiple platforms. Zombie Lupins but tiered layout reduces Heal hits." },

  // -- Aqua Road (non-undead but listed for reference - all MP water maps) --
  105030000: { healCoverage:2, platforms:3, layout:"tiered",  estimated:true, notes:"Deep Forest. MP water floor. Must stay on platforms to cast." },

  // -- Zombie Mushmom / Rotten Mushmom boss rooms --
  105090900: { healCoverage:2, platforms:3, layout:"tiered",  estimated:true, notes:"Boss sanctuary. Avoid solo - boss room only." },

  // -- Perion / Ellinia (non-undead reference maps) --
  101030402: { healCoverage:2, platforms:4, layout:"tiered",  estimated:true, notes:"Rocky Mountain. Multiple scattered platforms. Not a Heal map." },
  100030000: { healCoverage:3, platforms:3, layout:"tiered",  estimated:true, notes:"Forest of Evil Eye. 3 tiered platforms. Moderate layout." },
};
        ...
        <div style={{ display:"flex", gap:16, flexWrap:"wrap" }}>
          <div style={{ flex:"1 1 260px" }}>
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:6 }}>
              <div style={{ fontSize:10, color:"#6b7280", letterSpacing:1 }}>MINIMAP</div>
              {spawnInfo && (
                <button
                  onClick={()=>setShowSpawns(v=>!v)}
                  style={{
                    background: showSpawns ? "#ef444422" : "#21262d",
                    border: `1px solid ${showSpawns ? "#ef4444" : "#30363d"}`,
                    borderRadius:999, color: showSpawns ? "#ef4444" : "#9ca3af",
                    fontFamily:"inherit", fontSize:10, fontWeight:700,
                    padding:"2px 9px", cursor:"pointer", letterSpacing:0.5,
                  }}
                  title={`${spawnInfo.s.length} mob spawn point${spawnInfo.s.length===1?"":"s"} (Map.wz life data)`}
                >
                  ● Mob Spawns
                </button>
              )}
              {ropeSegs && spawnInfo && (
                <button
                  onClick={()=>setShowRopes(v=>!v)}
                  style={{
                    background: showRopes ? "#f59e0b22" : "#21262d",
                    border: `1px solid ${showRopes ? "#f59e0b" : "#30363d"}`,
                    borderRadius:999, color: showRopes ? "#f59e0b" : "#9ca3af",
                    fontFamily:"inherit", fontSize:10, fontWeight:700,
                    padding:"2px 9px", cursor:"pointer", letterSpacing:0.5, marginLeft:6,
                  }}
                  title={`${ropeSegs.length} rope/ladder segment${ropeSegs.length===1?"":"s"} (Map.wz ladderRope data)`}
                >
                  ┃ Ropes/Ladders
                </button>
              )}
            ...
            <div style={{ position:"relative", width:"100%", maxWidth:400 }}>
              ...
              {showSpawns && spawnInfo && (
                <div style={{ position:"absolute", inset:0, pointerEvents:"none" }}>
                  {spawnInfo.s.map(([x, cy], i) => {
                    const div = 2 ** spawnInfo.mag;
                    const px = (x + spawnInfo.centerX) / div;
                    const py = (cy + spawnInfo.centerY) / div;
                    return (
                      <div key={i} style={{
                        position:"absolute",
                        left:`${(px / spawnInfo.cw) * 100}%`,
                        top:`${(py / spawnInfo.ch) * 100}%`,
                        transform:"translate(-50%,-50%)",
                        width:6, height:6, borderRadius:"50%",
                        background:"#ef4444", border:"1px solid #fff8",
              ...
              {showRopes && ropeSegs && spawnInfo && (
                <svg viewBox={`0 0 ${spawnInfo.cw} ${spawnInfo.ch}`} preserveAspectRatio="none"
                  style={{ position:"absolute", inset:0, width:"100%", height:"100%", pointerEvents:"none" }}>
                  {ropeSegs.map(([x, y1, y2], i) => {
                    const div = 2 ** spawnInfo.mag;
                    const px = (x + spawnInfo.centerX) / div;
                    const py1 = (y1 + spawnInfo.centerY) / div;
                    const py2 = (y2 + spawnInfo.centerY) / div;
                    return (
                      <line key={i} x1={px} y1={py1} x2={px} y2={py2}
                        stroke="#f59e0b" strokeWidth={1} strokeDasharray="2,1.5" opacity={0.9} />
                    );
                  })}
                </svg>
              )}
